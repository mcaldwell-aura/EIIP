...
@Component({
  selector: 'app-forms-mockup-modal',
  imports: [
    CommonModule,
    FormsModule,
    RouterLink,
  ...
  templateUrl: './forms-mockup-modal.component.html',
  styleUrl: './forms-mockup-modal.component.scss',
})
export class FormsMockupModalComponent {
  ...
  private readonly activeFormId = signal<string | null>(null);
  protected readonly draft = signal<FormDraft | null>(null);
  ...
  protected updateDraftField(field: keyof FormDraft, value: string | InspectionFormStatus): void {
  ...
  protected addInspectionForm(): void {
    ...
    this.openFormModal(createdForm);
